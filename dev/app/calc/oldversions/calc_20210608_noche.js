...
$scope.getDataYadio = function() {
  ...
  var URLconsulta = "./simulador/api1_get.php";
    ...
    console.log('BTC/USD price: ' + $scope.BTC_USD_price);

    console.log('USD/Bs rate: ' + $scope.USD_VES_rate);

    console.log('BTC/Bs sell: ' + $scope.BTC_VES_sell);
...
$scope.getDataYadioMonedaPYG = function() {
  ...
  console.log('CtrlCalc.getDataYadioMonedaPYG.inicio (moneda: PYG)');
    ...
    console.log('CtrlCalc.getDataYadioMonedaPYG.fin');
