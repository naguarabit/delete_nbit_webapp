//controlador asociado a template de api/simulador.html
'use strict';
...
$scope.calcularMontoUSD = function(){
  ...
  $scope.montoUSD = $scope.monto1 / $scope.USD_PYG; 
...
$scope.calcularMontoDestino_A = function(){
  ...
  $scope.monto2 = monto2.toFixed(0); //aplicar round a 2 decimales
  console.log('monto2: ' + $scope.monto2);
