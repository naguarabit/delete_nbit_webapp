...
//y la guarda en la variable data3
  ...
  $scope.getDataYadioMonedaPYG = function() {
    ...
    console.log('CtrlApi.getDataYadioMonedaPYG.inicio. moneda: PYG');
    ...
    .then(function(response) {
      ...
      if (response.data.records != null){
        ...
        //console.log('CtrlApi.getDataYadioMonedaPYG.inicio. moneda: PEN. respuesta api:');
    ...
    console.log('CtrlApi.getDataYadioMonedaPYG.fin');
