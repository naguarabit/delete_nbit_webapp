...
$outp ='{"records":['.$outp.']}';
  ...
  //sin filtro de id
  $sql = "SELECT b.nombre user_nombre, \n"
      . "p.nombre origen_pais_nombre, \n"
      . "p2.nombre destino_pais_nombre, \n"
      . "p.cod_moneda as origen_cod_moneda, \n"
      . "p2.cod_moneda as destino_cod_moneda, \n"
      . "a.*, \n"
