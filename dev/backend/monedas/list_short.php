<?php
//TODO. este archivo deberia fusionarse con monedas/list.php, y se indica cual consulta realizar mediante
//un parametro GET['mod']
/*
users.php
2019-07-12
...
$sql ="SELECT codigo, nombre FROM moneda order by nombre";
